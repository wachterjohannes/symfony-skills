...
| `components` | about to hand-write a lock, queue, cache, HTTP client, mailer, scheduler, shell command, slug or file search, or add a library for one | `skills/components/SKILL.md` |
